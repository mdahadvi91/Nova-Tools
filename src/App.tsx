...
const MainContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative text-slate-900 dark:text-slate-100 selection:bg-emerald-500 selection:text-white w-full max-w-full overflow-x-hidden">
      {/* Background layer: Uses customBg or server-side /assets/background.jpg */}
      <div
        className="fixed inset-0 pointer-events-none z-0 bg-cover bg-center bg-no-repeat bg-slate-100 dark:bg-[#060b09] opacity-30 dark:opacity-100 transition-all duration-700 ease-in-out"
        style={{
